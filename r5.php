...
$con = mysqli_connect("localhost", "id15229633_entry1", "}EkUE!635IA#eTW~", "id15229633_entry"); 
 $q = "SELECT * FROM entry1 WHERE  Department= 'Instrumentation Engineering'";
 ...
 <td> <button class="btn-danger btn"> <a href="deleter5.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button> </td>
...
$con = mysqli_connect("localhost", "id15229633_entry1", "}EkUE!635IA#eTW~", "id15229633_entry"); 
$q = "SELECT * FROM entry2 WHERE  Department= 'Instrumentation Engineering'";
