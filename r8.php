...
$con = mysqli_connect("localhost", "id15229633_entry1", "}EkUE!635IA#eTW~", "id15229633_entry"); 
 $q = "SELECT * FROM entry1 WHERE  Department= 'Applied Science and Humanities'";
 ...
 <td> <button class="btn-danger btn"> <a href="deleter8.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button> </td>
...
$con = mysqli_connect("localhost", "id15229633_entry1", "}EkUE!635IA#eTW~", "id15229633_entry"); 
$q = "SELECT * FROM entry2 WHERE  Department= 'Applied Science and Humanities'";
